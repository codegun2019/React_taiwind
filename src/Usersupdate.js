            ...
            <div className="mt-2.5">
              <input
                ...
                className={`block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 ${
                  validationErrors && validationErrors.name ? "border-red-500" : ""
                }`}
              />
          ...
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                onChange={handleInputChange}
                className={`block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 ${
                  validationErrors && validationErrors.email ? "border-red-500" : ""
                }`}
              />
              {validationErrors && validationErrors.email && (
                <p className="mt-2 text-sm text-red-600" id="email-error">{validationErrors.email}</p>
              )}
            </div>
          </div>
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <input
                ...
                onChange={handleInputChange}
                className={`block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 ${
                  validationErrors && validationErrors.password ? "border-red-500" : ""
                }`}
              />
